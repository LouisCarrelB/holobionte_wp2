...
path_RDS = paste0("../data/RDS/",scenario,"/")
dir.create(paste0("~/work/holobionte_wp2/results/", scenario,"/")) 
...
```{r Modele,  warning=FALSE, message=TRUE,warning=FALSE,fig.width=15,fig.height=15, results='asis'}
<<Modele>>
```
